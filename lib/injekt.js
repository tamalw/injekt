(function () {
  ...
  var InjektBase = {
    ...
    '_isolate' : function (file, mocks, context, incl_defauls_flag) {
    ...
    '_extendContext' : function (mocks, current_context, incl_defaults_flag) {
    ...
    '_includeDefaults' : function (current_context) {
